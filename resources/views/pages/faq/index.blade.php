  ...
  <div class="container-fixed flex items-center justify-between flex-wrap gap-5">
   <div class="flex flex-col justify-center items-start flex-wrap gap-1 lg:gap-2">
    ...
    <div class="flex items-center gap-1 text-sm font-normal">
     <a class="text-gray-700">FAQ</a>
     <span class="text-gray-400 text-sm"> / </span>
     <a class="text-gray-700 hover:text-primary" href="#">{{ @$page }}</a>
    </div>
   </div>
   <div class="flex items-center flex-wrap gap-1.5 lg:gap-3.5">
    <a class="btn btn-light" href="{{ route('faq-create') }}">
      ...
      <div id="faq_datatable">
        ...
        <table class="table table-auto table-border" data-datatable-table="true">
          ...
          <tr>
            ...
            <th class="w-auto" data-datatable-column="question">
            <span class="sort">
              <span class="sort-label">
              Pertanyaan
              </span>
            ...
            <th class="min-w-40" data-datatable-column="answer">
            <span class="sort">
              <span class="sort-label">
              Jawaban
              </span>
...
@push('scripts')
  <script>
    const apiUrl = "{{ route('faq-datatable') }}";
    const element = document.querySelector('#faq_datatable');
        ...
        action: {
          render: (item, data, context) => {
            ...
            <div class="flex justify-center gap-2">
                ...
                <a href="faq/${data.id}/edit" class="btn btn-icon btn-outline btn-warning btn-sm btn-edit">
    ...
    // Delete record
    $('#faq_datatable').on('click', '.btn-delete', function() {
